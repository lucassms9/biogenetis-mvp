...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nome_completo' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_type_id' => 1,
                'cliente_id' => 1,
                'created' => '2020-05-26 20:39:03',
                'modified' => '2020-05-26 20:39:03',
            ],
        ];
        parent::init();
    }
