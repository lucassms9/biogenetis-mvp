...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'cc50317a59a36ea176646348cbda4e6cc32761d279729b6426b1f198464c0cf0'),
    ],
    ...
    'EmailSend' => [
        ...
        'smtp_user' => env('SMTP_USER', 'contato@testecovidexpress.com.br'),
        'smtp_password' => env('SMTP_PASSWORD', 'Covid@2020*'),
    ],
    ...
    //     'smtp_host' => env('SMTP_HOST', ''),
    //     'smtp_port' => env('SMTP_PORT', '465'),
    //     'smtp_user' => env('SMTP_USER', 'lucas.santos@dedtechsolutions.com.br'),
    //     'smtp_password' => env('SMTP_PASSWORD', 'fx8350lucas'),
    // ],
    /**
    ...
    'Datasources' => [
        ...
        //     'host' => env('DB_HOST','localhost'),          // Database host name or IP address
        //     //'port' => 'nonstandard_port', // Database port number (default: 1521)
        //     'username' => env('DB_USER','root'),          // Database username
        //     'password' => env('DB_PASS','root'),       // Database password
        //     'database' => env('DB_NAME','biogenetics'),             // Database name (maps to Oracle's `SERVICE_NAME`)
        ...
        'default' => [
            ...
            'database' => env('DB_NAME','biogenetics'),
            'timezone' => 'UTC',
            'flags' => [],
            'cacheMetadata' => true,
            'log' => false,
