...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-4">
            <?php echo $this->Form->control('data_primeiros_sintomas',['label' => 'Data dos primeiros sintomas','type' => 'text', 'class' => ['form-control'], 'disabled' => $disabled]); ?>
        </div>
    </div>
...
<div class="row">
    <div style="display: flex;" class="col-md-12">
        ...
        <?php echo $this->Form->radio('analgesico_antitermico_antiinflamatorio', ['SIM', 'NÃO'], ['style' => 'margin: 0 10px;', 'disabled' => $disabled]); ?>
    </div>
</div>
    ...
    <div class="row">
        <div style="display: flex;" class="col-md-3">
            <?php echo $this->Form->control('clinico_febre',['label' => 'FEBRE - TEMPERATURA DE:','type' => 'checkbox', 'class' => ['custom-style-check',], 'disabled' => $disabled]); ?>
                    <input style="width: 20%;" type="text" class="form-control" name="clinico_febre_temp" <?= $disabled ? 'disabled' : '' ?>>
        </div>
        <div class="col-md-3">
...
<div class="row">
    <div style="display: flex;" class="col-md-12">
        ...
        ], ['style' => 'margin: 0 10px;', 'disabled' => $disabled]); ?>
...
<div class="row">
    ...
    <div class="col-md-12">
        <?php echo $this->Form->control('paciente_contato_pessoa_com_suspeita_covid_local_desc', ['label' => 'OUTRO, ESPECIFICAR:', 'class' => 'form-control', 'disabled' => $disabled]); ?>
    </div>
</div>
