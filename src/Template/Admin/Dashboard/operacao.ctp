                    ...
                    <div class="card-body">
                        <div class="row">
                            <div style="display: flex;" class="col-12">
                                <div class="content">
                                    <a href="<?= $this->Url->build('/admin/pacientes/add', true);?>" class="btn btn-sm">
                                        <div style="padding: 10px;" class="card text-white bg-danger">
                                                <div style="display: flex;">
                                                    <h5 style="margin: 4px;" class="text-white">Aguardando Atendimento</h5><i style="font-size: 20px;" class="mdi mdi-progress-clock"></i>
                                                </div>
                                                <div class="card-title"><h3 class="text-white"><?= $result['aguardando_atendimento'] ?></h3></div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="content">
                                    <a href="<?= $this->Url->build('/admin/atendimentos', true);?>" class="btn btn-sm">
                                        <div style="padding: 10px;" class="card text-white bg-warning">
                                                ...
                                                <div class="card-title"><h3 class="text-white"><?= $result['atendimento'] ?></h3></div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="content">
                                    <a href="#" class="btn btn-sm">
                                        <div style="padding: 10px;" class="card text-white bg-info">
                                                ...
                                                <div class="card-title"><h3 class="text-white"><?= $result['triagem'] ?></h3></div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="content">
                                    <a href="#" class="btn btn-sm">
                                        <div style="padding: 10px; background-color:#4399f0" class="card text-white">
                                                ...
                                                <div class="card-title"><h3 class="text-white"><?= $result['diagnostico'] ?></h3></div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="content">
                                    <a href="#" class="btn btn-sm">
                                        <div style="padding: 10px;" class="card text-white bg-success">
                                                ...
                                                <div class="card-title"><h3 class="text-white"><?= $result['finalizados'] ?></h3></div>
                                        </div>
                                    </a>
                                </div>
